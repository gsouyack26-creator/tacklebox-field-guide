(() => {
  ...
  function renderLineComparison() {
    ...
    $("#line-comparison-head").innerHTML = `<th scope="col">Decision point</th>${lineComparison.products.map(item => `<th scope="col">${escapeHtml(item.maker)} ${escapeHtml(item.name)}</th>`).join("")}`;
